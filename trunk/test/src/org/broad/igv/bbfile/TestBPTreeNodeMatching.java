...
public class TestBPTreeNodeMatching {
	...
	public void testNodeMatching(){
		BPTreeLeafNodeItem bpi1=new BPTreeLeafNodeItem(0, "chr1", 0, 1000);
		BPTreeLeafNodeItem bpi2=new BPTreeLeafNodeItem(1, "chr12", 1, 2000);
		Assert.assertEquals(false,bpi1.chromKeysMatch(bpi2.getChromKey()));
	}
}
